defmodule PhoenixAnalytics.Web.Live.Components.Header do
  @moduledoc false
      ...
      <div class="flex items-center justify-between border-b border-zinc-100 gap-2 px-4 py-2 sm:px-6 lg:px-2 text-sm">
        ...
        <div class="flex items-center gap-2">
          ...
          <img
            ...
            src="https://img.shields.io/github/stars/lalabuy948/PhoenixAnalytics"
  ...
  def update(assigns, socket) do
    {:ok, assign(socket, :date_range, assigns.date_range)}
  end

  @impl true
  def handle_event("set_date", %{"value" => %{"from" => from, "to" => to}}, socket) do
    send(self(), {:set_date, %{from: from, to: to}})
    {:noreply, socket}
  end
end
